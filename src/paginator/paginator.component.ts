...
@Component({
    ...
    template: `
        ...
        <ul class="pagination justify-content-center" [ngClass]="{'pagination-lg' : size =='large','pagination-md' : size =='medium','pagination-sm' : size =='small'}" style="background-color: f6f7f9;border: 1px solid #d9d9d9;">
            <li class="page-item " style="cursor: pointer;" (click)="onFirstClick()">
            ...
            <li style="cursor: pointer;" class="page-item {{activePageIndex == pagesArray.length ? 'disabled' : ''}}" (click)="onNext()">
                <a class="page-link" aria-label="Next">
                    <span aria-hidden="true">&#x3E;</span>
                    <span class="sr-only">Next</span>
                </a>
            </li>
            <li style="cursor: pointer;" class="page-item" (click)="onLastClick()">
                <a class="page-link" aria-label="Next">
