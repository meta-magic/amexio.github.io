...
@Component({
  ...
  `,
  providers: [
    { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => RatingMediaComponent), multi: true },
    { provide: NG_VALIDATORS, useExisting: forwardRef(() => RatingMediaComponent), multi: true },
  ],
  styles : [
    `/**
...
export class RatingMediaComponent implements OnInit, ControlValueAccessor, Validator {
