...
const distFolder = path.join(rootFolder, 'dashboard');
...
gulp.task('rollup:umd', function () {
  ...
  // transform the files here.
    ...
    .pipe(rename('amexio-dashboard.umd.js'))
    .pipe(gulp.dest(distFolder));
});
...
gulp.task('copy:rootbuild',function () {
    gulp.src(['dashboard/**/*']).pipe(gulp.dest('../../../dist/dashboard/'));
    console.log('Adding DASHBOARD to amexio-ng-extensions build......');
});
