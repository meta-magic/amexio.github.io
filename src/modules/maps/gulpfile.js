...
const distFolder = path.join(rootFolder, 'maps');
...
gulp.task('rollup:umd', function () {
  ...
  // transform the files here.
    ...
    .pipe(rename('amexio-maps.umd.js'))
    .pipe(gulp.dest(distFolder));
});
...
gulp.task('copy:rootbuild',function () {
    gulp.src(['maps/**/*']).pipe(gulp.dest('../../../dist/maps/'));
    console.log('Adding MAPS to amexio-ng-extensions build......');
});
