      ...
      <div class="col-lg-6 col-sm-12 content-area" style="color: white;padding-left: 30px;">
        ...
        <ul style="padding-left: 0">
          ...
          <li *ngIf="enableMyList" >
            ...
            <!--<amexio-ee-btn [cClass]="'secondarybutton'" [label]="'MY LIST'" [icon]="'fa fa-plus'" [type]="'secondary'" [tooltipMessage]="'My List'" [size]="size" (onClick)="addToList()"></amexio-ee-btn>--></li>
          <li>
            <a   [ngClass]="getClassName()" (click)="likeClick()"><i class="fa fa-thumbs-o-up fa-lg" aria-hidden="true"></i>
          </a>
          </li>
