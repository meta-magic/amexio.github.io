...
describe('amexio-date-time-picker', () => {
  ...
  it('setDateData()', () => {
    let state: string, mon = 9, event1: any;
  ...
  it('resetselection()', () => {
    const dateObj = new Date('Thu Jul 25 2017 00:00:00 GMT+0530 (IST)');
    const daysArray: any = [];
    let rowDays: any;
    const day: any = {
  ...
  it('validateMaxDate()', () => {
    const days = new Date('27-May-2017');
    const max = new Date('22-Feb-2015');;
  ...
  it('yearFlagNegate()', () => {
    const element = { year: 0, flag: true, disabled: false };
    comp['yearFlagNegate'](element);
  });

  it('elementFlagMethod()', () => {
    const element = { year: 0, flag: false, disabled: false };
  ...
  it('yearFlag()', () => {
    const element = { year: 2010, flag: false, disabled: false };
  ...
  it('alterBackForwardArrow()', () => {
    const element = { year: 2016, flag: false, disabled: false };
    comp.minDate = '27-Mar-2016';
    comp.maxDate = '22-Feb-2019';
  ...
  it('alterBackArrow()', () => {
    const element = { year: 2016, flag: true, disabled: false };
    comp.minDate = '27-Mar-2016';
    const min = new Date(comp.minDate);
