...
import { Renderer, Renderer2, TemplateRef } from '@angular/core';
...
describe('amexio-tree-filter-view', () => {
  ...
  it('ngoninit() first if', () => {
    ...
    const fixture1 = TestBed.createComponent(AmexioFilterTreeComponent);
    let wrapperComponent = fixture1.componentInstance;

    // get a reference to the actual component we want
    const component = fixture1.componentInstance.templates;
  ...
  it('filterOption() first for if', () => {
    const data = { key: "Is Not Equal To", value: 2, type: 'string', checkedStatus: '' };
  ...
  it('generatefilterIndex method call', () => {
    ...
    comp.childarraykey = 'children';
    const parentId = 1;
    const rannumber = Math.floor(Math.random() * 1000 + 999 + 1);
