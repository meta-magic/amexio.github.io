...
import {
  AfterContentInit, ChangeDetectorRef, Component, ContentChild, DoCheck, EventEmitter,
  HostListener, Input, OnInit, Output, QueryList, TemplateRef} from '@angular/core';
...
version : 4.2 onwards
default : none
description : Position of notification window vertically: top or bottom or center.
This attribute is ignored if user specify position explicitly
(using position-top/position-bottom/position-center/position-right/position-left)
*/
  ...
  left or right or center. This attribute is ignored if user specify position
   explicitly (using position-top/position-bottom/position-center/position-left/position-right)
  */
