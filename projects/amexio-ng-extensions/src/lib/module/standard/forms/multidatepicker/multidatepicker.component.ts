...
export class AmexioMultipleDatePickerComponent extends ListBaseDatepickerComponent<string> implements OnInit, AfterContentInit, Validators {
  dropdownListOneArrowDown: any;
  dropdownListTwoArrowDown: any;
  dropdownListTwoArrowUp: any;
  dropdownListOneArrowUp: any;

  yearList1ArrowDown: any;
  yearList1ArrowUp: any;
  yearList2ArrowDown: any;
  yearList2ArrowUp: any;
  backArrowFlag: any;
  forwardArrowFlag: any;
  cancelispressed: any;
