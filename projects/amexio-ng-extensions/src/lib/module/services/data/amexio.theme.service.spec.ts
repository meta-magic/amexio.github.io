...
// import {AmexioThemeSwitcherService} from './amexio.theme.service';
...
//    let comp1: AmexioThemeSwitcherService;
//    let fixture1: ComponentFixture<AmexioThemeSwitcherService>;
//    let themeData;
//    let _http;
//   beforeEach(() => {
//     TestBed.configureTestingModule({
//       imports: [FormsModule],
//       declarations: [ AmexioNavDesktopMenuComponent,AmexioFormActionCEComponent, SpeechBubbleComponent, 
...
//         AmexioCardCEActionComponent, AmexioImageComponent, AmexioCardCEComponent, AmexioThemeSwitcherService,
//         AmexioCardCEHeaderComponent, CommonIconComponent],
//       providers: [IconLoaderService, DeviceQueryService, HttpClient],
//     });
//     fixture1 = TestBed.createComponent(AmexioThemeSwitcherService);
...
// it('constructor()', () => {
//     let sv =  HttpClient;
//    comp1.constructor(sv);
   
// });
 
// it('loadThemes()', () => {
//     let url = ''
//     comp1.loadThemes(url);
